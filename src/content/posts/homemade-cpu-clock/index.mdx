...
<ImageCaption src={squareWave.src} alt="A square wave under an oscilloscope." />
...
<ImageCaption
  src={internals555.src}
  alt="The internal diagram of a 555 timer."
/>
...
<ImageCaption src={latch555.src} alt="The SR latch inside the 555 timer." />
...
<div class="col-2" style="align-items: end;">
  <ImageCaption
    src={ls04.src}
    alt="Logical diagram of the 74LS04 Hex Inverter."
  />
  <ImageCaption
    src={ls08.src}
    alt="Logical diagram of the 74LS08 Quad AND Gate."
  />
  <ImageCaption
    src={ls32.src}
    alt="Logical diagram of the 74LS32 Quad OR Gate."
  />
</div>
